export function initUIRotazioneFerie() {
    ...
    style.innerHTML = `
        ...
        /* VISTE E CONTENITORI */
        .ferie-view-container { width: 100%; display: none; flex-direction: column; gap: 16px; text-align: center; }
        
        /* PULSANTI TOP BAR */
        .ferie-top-actions { width: 100%; display: flex; gap: 12px; margin-bottom: 20px; flex-shrink: 0;}
        ...
        /* PULSANTI GENERALI */
        .ferie-btn-action { background-color: var(--success); color: white; border: none; padding: 16px; font-size: 15px; font-weight: 700; border-radius: var(--radius-md); cursor: pointer; width: 100%; transition: all 0.2s; margin-top: 10px; display: flex; justify-content: center; align-items: center; gap: 8px; box-shadow: 0 4px 12px rgba(15,157,88,0.2); flex-shrink: 0;}
        ...
        /* TABS */
        .ferie-tabs { display: flex; background: var(--surface-hover); border-radius: var(--radius-md); overflow: hidden; margin-bottom: 20px; width: 100%; border: 1px solid var(--border-color); padding: 4px; flex-shrink: 0;}
    ...
    container.onclick = (e) => { window.chiudiSuSfondo(e, 'modal-rotazione-ferie-main') };
    ...
    container.innerHTML = `
        <div class="modal-content" style="max-width: 500px; height: 85vh; display: flex; flex-direction: column; padding: 20px; position: relative;">
            ...
            <i class="fa-solid fa-xmark close-modal" style="position: absolute; right: 20px; top: 20px; font-size: 24px; cursor: pointer; color: var(--text-muted); transition: 0.2s;" onmouseover="this.style.color='var(--danger)'" onmouseout="this.style.color='var(--text-muted)'" onclick="window.chiudiModal('modal-rotazione-ferie-main')"></i>
            
            <div class="ferie-header" style="border: none; margin-bottom: 10px; padding-bottom: 0;">
                <h2 style="margin-top: 0; border-bottom: 1px solid var(--border-color); padding-bottom: 15px; width: 100%;">
        ...
        <!-- MODALE SECONDARIA: CONDIVISIONE FERIE -->
        <div id="modal-condivisione-ferie" class="modal-overlay" style="z-index: 7500; display: none;" onclick="window.chiudiSuSfondo(event, 'modal-condivisione-ferie')">
            <div class="modal-content" style="max-width: 500px; height: 85vh; display: flex; flex-direction: column; padding: 20px; position: relative;">
                <i class="fa-solid fa-xmark close-modal" style="position: absolute; right: 20px; top: 20px; font-size: 24px; cursor: pointer; color: var(--text-muted); transition: 0.2s;" onmouseover="this.style.color='var(--danger)'" onmouseout="this.style.color='var(--text-muted)'" onclick="window.chiudiModal('modal-condivisione-ferie')"></i>
                
                <h3 style="text-align: center; margin-top: 0; margin-bottom: 20px; color: var(--text-main); font-weight: 800; border-bottom: 1px solid var(--border-color); padding-bottom: 15px; flex-shrink: 0;"><i class="fa-solid fa-clipboard-user" style="color: var(--primary);"></i> Le mie Ferie</h3>
                ...
                <div style="flex: 1; min-height: 0; overflow-y: auto; padding-right: 10px; display: flex; flex-direction: column;">
                    ...
                    <button id="ferie-btnSalvaFerie" class="ferie-btn-action" onclick="window.salvaFerie()" style="margin-bottom: 20px;"><i class="fa-solid fa-floppy-disk"></i> Salva Dati Profilo</button>
                </div>
            </div>
        </div>

        <!-- MODALE SECONDARIA: NUOVO ANNUNCIO -->
        <div id="modal-annuncio-ferie" class="modal-overlay" style="z-index: 7500; display: none;" onclick="window.chiudiSuSfondo(event, 'modal-annuncio-ferie')">
            <div class="modal-content" style="max-width: 500px; height: 85vh; display: flex; flex-direction: column; padding: 20px; position: relative;">
                <i class="fa-solid fa-xmark close-modal" style="position: absolute; right: 20px; top: 20px; font-size: 24px; cursor: pointer; color: var(--text-muted); transition: 0.2s;" onmouseover="this.style.color='var(--danger)'" onmouseout="this.style.color='var(--text-muted)'" onclick="window.chiudiModal('modal-annuncio-ferie')"></i>
                
                <h3 id="ferie-titoloModalAnnuncio" style="margin-top: 0; margin-bottom: 20px; color: var(--text-main); font-weight: 800; border-bottom: 1px solid var(--border-color); padding-bottom: 15px; flex-shrink: 0;"><i class="fa-solid fa-bullhorn" style="color: var(--primary);"></i> Nuovo Annuncio</h3>
                ...
                <div style="flex: 1; min-height: 0; overflow-y: auto; padding-right: 10px; display: flex; flex-direction: column;">
                    ...
                    <button id="ferie-btnSalvaAnnuncio" class="ferie-btn-action" onclick="window.pubblicaAnnuncioFerie()" style="margin-bottom: 20px;"><i class="fa-solid fa-paper-plane"></i> Pubblica Annuncio</button>
                </div>
            </div>
        </div>
    `;
