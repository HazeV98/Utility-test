export function initUIAdmin() {
    ...
    style.innerHTML = `
        ...
        .admin-view-container { width: 100%; max-width: 440px; display: flex; flex-direction: column; gap: 20px; }
        ...
        .admin-header h2 { margin: 0; color: var(--danger); font-size: 24px; display: flex; align-items: center; gap: 10px;}
    ...
    container.innerHTML = `
        <div class="admin-wrapper">
            <div class="admin-view-container">
                <div class="admin-header">
                    <button style="background:none; border:none; font-size: 20px; color: var(--text-main); cursor:pointer; padding:10px; transition: 0.2s;" onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color='var(--text-main)'" onclick="window.chiudiModal('modal-admin-main')"><i class="fa-solid fa-arrow-left"></i></button>
        ...
        <div id="modal-delete-confirm" class="modal-overlay">
            <div class="modal-content">
                <i class="fa-solid fa-xmark close-modal" onclick="window.chiudiModalElimina()"></i>
