export function initUIDDS() {
    ...
    style.innerHTML = `
        ...
        .dds-header h2 { margin: 0; color: var(--primary); font-size: 24px; font-weight: 800; display: flex; align-items: center; gap: 8px; letter-spacing: -0.5px; }

        .dds-content-area { width: 100%; max-width: 440px; display: flex; flex-direction: column; gap: 20px; }
        
        /* CARD DDS */
        .dds-card { background: var(--surface); padding: 20px; border-radius: var(--radius-md); box-shadow: var(--shadow-sm); display: flex; flex-direction: column; gap: 12px; border-left: 6px solid var(--primary); transition: transform 0.2s, box-shadow 0.2s; }
        ...
        .dds-btn-add-main { background-color: var(--success); color: white; border: none; padding: 16px; font-size: 15px; font-weight: 700; border-radius: var(--radius-md); cursor: pointer; box-shadow: 0 4px 12px rgba(15,157,88,0.2); width: 100%; display: flex; justify-content: center; align-items: center; gap: 10px; transition: all 0.2s; }
        ...
        .dds-backup-group { display: flex; gap: 12px; width: 100%; }
        ...
        /* SOTTOMODALE */
        .dds-input-group { display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px; }
        ...
        .dds-btn-esegui { background-color: var(--success); color: white; border: none; padding: 16px; font-size: 15px; font-weight: 700; border-radius: 12px; cursor: pointer; width: 100%; margin-top: 10px; margin-bottom: 12px; display: flex; justify-content: center; align-items: center; gap: 8px; transition: all 0.2s;}
        .dds-btn-esegui:active { transform: scale(0.98); }
        
        .dds-btn-chiudi { background-color: transparent; color: var(--text-muted); border: 1px solid var(--border-color); padding: 14px; font-size: 15px; font-weight: 600; border-radius: 12px; cursor: pointer; width: 100%; text-align: center; transition: all 0.2s;}
    ...
    container.innerHTML = `
        <div class="dds-wrapper">
            <div class="dds-header">
                <button style="background:none; border:none; font-size: 20px; color: var(--text-main); cursor:pointer; padding:10px; transition: 0.2s;" onmouseover="this.style.color='var(--primary)'" onmouseout="this.style.color='var(--text-main)'" onclick="window.chiudiModal('modal-dds-main')"><i class="fa-solid fa-arrow-left"></i></button>
                <h2><i class="fa-solid fa-box-archive"></i> Archivio DDS</h2>
                <div style="width: 44px;"></div>
            </div>

            <div class="dds-content-area">
        ...
        <div id="modal-aggiungi-dds" class="modal-overlay" style="z-index: 7500;">
            <div class="modal-content">
                <i class="fa-solid fa-xmark close-modal" style="position: absolute; right: 24px; top: 24px; font-size: 24px; cursor: pointer; color: var(--text-muted);" onclick="window.chiudiModal('modal-aggiungi-dds')"></i>
