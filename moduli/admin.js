// admin.js - Modulo di amministrazione unificato
...
export function avviaMotoreAdmin() {
    // Inizializza il token se salvato nel localStorage
    ...
    // Inizializza flatpickr per le varianti (se l'elemento esiste già nel DOM)
    if (document.getElementById('var-date') && window.flatpickr) {
        window.initVarianti('multiple');
    }
}

window.gestisciMemoriaToken = function(token, remember) {
...
// ==========================================
window.aggiornaMappaFiles = async function(owner, repo, token) {
    try {
        let listaRotazioni = [];
        try {
...
// ==========================================
window.forzaMappa = async function() {
...
// ==========================================
window.caricaDatiCalendario = async function() {
    const owner = document.getElementById('gh-owner').value.trim();
    const repo = document.getElementById('gh-repo').value.trim();
    const token = document.getElementById('gh-token').value.trim();
...
window.salvaDatiCalendario = async function() {
    const owner = document.getElementById('gh-owner').value.trim();
    const repo = document.getElementById('gh-repo').value.trim();
    const token = document.getElementById('gh-token').value.trim();
    const statusLog = document.getElementById('status-log-cal');
...
// ==========================================
window.caricaZip = async function() {
    const owner = document.getElementById('gh-owner').value.trim(); 
    const repo = document.getElementById('gh-repo').value.trim(); 
    const token = document.getElementById('gh-token').value.trim();
...
// ==========================================
// MODULO: ELIMINAZIONE MULTIPLA
// ==========================================
window.caricaElencoFile = async function() {
    const owner = document.getElementById('gh-owner').value.trim();
    const repo = document.getElementById('gh-repo').value.trim();
    const token = document.getElementById('gh-token').value.trim();
...
window.disegnaElencoFile = function(lista, isSearch = false) {
...
window.toggleFolderVisibility = function(folderId) {
...
window.filtraElencoFile = function() {
...
window.selezionaTuttiFile = function(seleziona) {
...
window.aggiornaContatoreSelezione = function() {
...
window.preparaEliminazione = function() {
...
// ==========================================
window.initVarianti = function(mode = 'multiple') {
...
window.setVariantiMode = function(mode) {
...
window.salvaVarianti = async function() {
    const owner = document.getElementById('gh-owner').value.trim();
    const repo = document.getElementById('gh-repo').value.trim();
    const token = document.getElementById('gh-token').value.trim();
